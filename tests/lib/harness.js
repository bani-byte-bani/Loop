...
const SIGNALS = {
  ...
  // 継ぎ目(回転による不連続点)を探すための正弦波。
  //
  // 条件が2つある。
  //  ・バッファ長と非整数周期であること。440Hz は 2 秒バッファに 880 周期
  //    ちょうど収まってしまい、回転させても波形が連続のままで継ぎ目が出ない。
  //  ・周波数が十分低いこと。継ぎ目の段差は録音開始位相しだいの乱数で、
  //    運悪く前後の位相が近いと段差が小さくなる。これを「継ぎ目なし」と
  //    誤判定しないためには、正弦波自身の最大傾き(2πf/sr)より十分大きい
